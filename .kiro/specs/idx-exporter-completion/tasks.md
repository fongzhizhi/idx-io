...
- [ ] 3. 优化XML结构和验证
  - [~] 3.1 修复组件ItemType问题
    - 在src/exporter/builders/component-builder.ts中修改ItemType为SINGLE
    - 确保所有组件使用正确的ItemType值
    - _Requirements: 3.1_
  
  - [~] 3.2 实现ValidationEngine增强版本
...
- [ ] 5. 实现XML注释支持
  ...
  - [~] 5.3 更新IDXExporter使用带注释的XMLWriter
