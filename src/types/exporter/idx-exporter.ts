...
// ============= 类型守卫函数 =============
// 注意：类型守卫函数已移动到 src/utils/validation.ts

// ============= 工具函数 =============
// 注意：工具函数已移动到相应的utils文件中：
// - 验证函数：src/utils/validation.ts
// - 层相关函数：src/utils/layer-utils.ts  
// - 几何工厂函数：src/utils/geometry-factory.ts
